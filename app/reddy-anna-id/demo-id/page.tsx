...
export const metadata: Metadata = {
  title: "Reddy Anna Demo ID | Free Practice Betting Account — Try Risk Free",
  description:
    "Get a free Reddy Anna Demo ID instantly via WhatsApp. Practice IPL betting, casino games & sports wagering with ₹10,000 virtual coins — no deposit needed.",
  alternates: {
    canonical: "https://www.reddyreal.guru/reddy-anna-id/demo-id",
  },
  openGraph: {
    title: "Reddy Anna Demo ID | Free Practice Betting Account",
    description:
      "Practice IPL betting, casino games & sports wagering for free with a Reddy Anna Demo ID. ₹10,000 virtual coins, no deposit required.",
    url: "https://www.reddyreal.guru/reddy-anna-id/demo-id",
  ...
  twitter: {
    ...
    title: "Reddy Anna Demo ID | Free Practice Betting Account",
    description: "Practice IPL & casino games risk-free with Reddy Anna Demo ID.",
  },
};
    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-8 select-none">
      <div className="w-full flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-3/4 flex flex-col gap-8 text-left">
          ...
          <section className="w-full bg-[#0c1322] border border-[#00C853]/10 rounded-3xl p-6 md:p-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-[#05080f] p-5 rounded-2xl border border-[#00C853]/5 shadow-md">
          ...
          <section className="w-full bg-[#0c1322] border border-[#00C853]/10 rounded-3xl p-6 md:p-8 flex flex-col gap-4">
            <h3 className="text-[#AEEA00] font-black text-xl md:text-2xl tracking-wide mb-2">
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-2">
              {[
                ...
                <div key={idx} className="flex-1 bg-[#05080f] p-5 rounded-2xl border border-[#00C853]/5 flex flex-col items-center text-center gap-2">
                  <span className="w-8 h-8 rounded-full bg-gradient-to-r from-[#AEEA00] to-[#00C853] text-black font-black flex items-center justify-center text-sm shadow-md">
                    {step.step}
                  </span>
          ...
          <section className="w-full bg-[#0c1322] border border-[#00C853]/10 rounded-3xl p-6 md:p-8 text-center flex flex-col items-center gap-4">
